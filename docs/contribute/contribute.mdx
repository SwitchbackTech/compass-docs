...
- **Transparency**: Code isn't the only thing that we're transparent about. We publish our <a href={HANDBOOK_URL} target="_blank" rel="noopener noreferrer">handbook</a>, technical guides, docs, and lessons-learned across our repos and social media. Working in an open culture will give you more opportunities to grow as an engineer and leader.
...
1. For the most up-to-date, low-level documentation, review the [docs in the Compass codebase](https://github.com/SwitchbackTech/compass/tree/main/docs).
